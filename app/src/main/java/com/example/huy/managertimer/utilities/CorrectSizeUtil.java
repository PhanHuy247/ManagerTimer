...
public class CorrectSizeUtil {
     ...
     */
    private int screenWidthOriginal = 1440;
//	private int screenHeightOriginal = 1136;

//	private float mOriginalRatio = 640 / 1136;

//	private float mCurrentRatio = 0;
    ...
    public void setIsUseTag(boolean isUseTag) {
        this.isUseTag = isUseTag;
    }

    public static CorrectSizeUtil getInstance(Context context) {
        if (sCorrectSizeUtil == null) {
            sCorrectSizeUtil = new CorrectSizeUtil(context);
        }
        if (sCorrectSizeUtil.mActivity == null) {
            sCorrectSizeUtil = new CorrectSizeUtil(context);
        }
        if (sCorrectSizeUtil.mActivity != context) {
            sCorrectSizeUtil = new CorrectSizeUtil(context);
        }
